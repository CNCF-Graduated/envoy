...
#include "include/envoy/tracing/_virtual_includes/trace_reason_interface/envoy/tracing/trace_reason.h"
...
public:
  ...
  void
  setRequestIDProvider(const Http::RequestIdStreamInfoProviderSharedPtr& provider) override {
